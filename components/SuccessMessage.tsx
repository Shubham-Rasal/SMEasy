  ...
  return (
    ...
    >
      <Image
        ...
        className="md:mb-4"
      />
      <h4 className="text-2xl font-semibold text-black md:text-3xl">
        Thank you!
      </h4>
      <p className="text-sm max-w-md text-neutral-900 md:text-base">
      ...
      <div className="flex items-center mt-6">
        <div className="relative after:pointer-events-none after:absolute after:inset-px after:rounded-[11px] after:shadow-highlight after:shadow-white/10 focus-within:after:shadow-[#77f6aa] after:transition">
          <Button
            onClick={refresh}
            className="relative text-neutral-900 bg-neutral-200 border border-black/20  shadow-black/10 rounded-xl hover:text-white"
          >
